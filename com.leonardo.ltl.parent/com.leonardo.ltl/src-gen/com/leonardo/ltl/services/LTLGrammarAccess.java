...
public class LTLGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class TestCaseElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cPostconditionKeyword_3_6_0 = (Keyword)cGroup_3_6.eContents().get(0);
		private final Assignment cPostconditionAssignment_3_6_1 = (Assignment)cGroup_3_6.eContents().get(1);
		private final RuleCall cPostconditionSTRINGTerminalRuleCall_3_6_1_0 = (RuleCall)cPostconditionAssignment_3_6_1.eContents().get(0);
		private final Group cGroup_3_7 = (Group)cUnorderedGroup_3.eContents().get(7);
		private final Keyword cInputsKeyword_3_7_0 = (Keyword)cGroup_3_7.eContents().get(0);
		private final Assignment cInputsAssignment_3_7_1 = (Assignment)cGroup_3_7.eContents().get(1);
		private final RuleCall cInputsSTRINGTerminalRuleCall_3_7_1_0 = (RuleCall)cInputsAssignment_3_7_1.eContents().get(0);
		...
		private final Assignment cInputsAssignment_3_7_2_1 = (Assignment)cGroup_3_7_2.eContents().get(1);
		private final RuleCall cInputsSTRINGTerminalRuleCall_3_7_2_1_0 = (RuleCall)cInputsAssignment_3_7_2_1.eContents().get(0);
		private final Group cGroup_3_8 = (Group)cUnorderedGroup_3.eContents().get(8);
		private final Keyword cEntitiesKeyword_3_8_0 = (Keyword)cGroup_3_8.eContents().get(0);
		private final Assignment cTestsAssignment_3_8_1 = (Assignment)cGroup_3_8.eContents().get(1);
		private final CrossReference cTestsTestableEntityCrossReference_3_8_1_0 = (CrossReference)cTestsAssignment_3_8_1.eContents().get(0);
		private final RuleCall cTestsTestableEntityQualifiedNameParserRuleCall_3_8_1_0_1 = (RuleCall)cTestsTestableEntityCrossReference_3_8_1_0.eContents().get(1);
		private final Keyword cEndKeyword_3_8_2 = (Keyword)cGroup_3_8.eContents().get(2);
		private final Group cGroup_3_9 = (Group)cUnorderedGroup_3.eContents().get(9);
		private final Keyword cRequirementsKeyword_3_9_0 = (Keyword)cGroup_3_9.eContents().get(0);
		private final Assignment cDemonstratesSatisfactionOfAssignment_3_9_1 = (Assignment)cGroup_3_9.eContents().get(1);
		private final CrossReference cDemonstratesSatisfactionOfTestRequirementCrossReference_3_9_1_0 = (CrossReference)cDemonstratesSatisfactionOfAssignment_3_9_1.eContents().get(0);
		private final RuleCall cDemonstratesSatisfactionOfTestRequirementQualifiedNameParserRuleCall_3_9_1_0_1 = (RuleCall)cDemonstratesSatisfactionOfTestRequirementCrossReference_3_9_1_0.eContents().get(1);
		private final Keyword cEndKeyword_3_9_2 = (Keyword)cGroup_3_9.eContents().get(2);
		private final Keyword cEndKeyword_4 = (Keyword)cGroup.eContents().get(4);
		...
		//'postcondition'
		public Keyword getPostconditionKeyword_3_6_0() { return cPostconditionKeyword_3_6_0; }
		
		//postcondition=STRING
		public Assignment getPostconditionAssignment_3_6_1() { return cPostconditionAssignment_3_6_1; }
		
		//STRING
		public RuleCall getPostconditionSTRINGTerminalRuleCall_3_6_1_0() { return cPostconditionSTRINGTerminalRuleCall_3_6_1_0; }
		
		//('inputs' inputs+=STRING ("," inputs+=STRING)*)?
		public Group getGroup_3_7() { return cGroup_3_7; }
		
		//'inputs'
		public Keyword getInputsKeyword_3_7_0() { return cInputsKeyword_3_7_0; }
		
		//inputs+=STRING
		public Assignment getInputsAssignment_3_7_1() { return cInputsAssignment_3_7_1; }
		
		//STRING
		public RuleCall getInputsSTRINGTerminalRuleCall_3_7_1_0() { return cInputsSTRINGTerminalRuleCall_3_7_1_0; }
		...
		//inputs+=STRING
		public Assignment getInputsAssignment_3_7_2_1() { return cInputsAssignment_3_7_2_1; }
		
		//STRING
		public RuleCall getInputsSTRINGTerminalRuleCall_3_7_2_1_0() { return cInputsSTRINGTerminalRuleCall_3_7_2_1_0; }
		...
		//'entities'
		public Keyword getEntitiesKeyword_3_8_0() { return cEntitiesKeyword_3_8_0; }
		
		//(tests+=[TestableEntity|QualifiedName])*
		public Assignment getTestsAssignment_3_8_1() { return cTestsAssignment_3_8_1; }
		
		//[TestableEntity|QualifiedName]
		public CrossReference getTestsTestableEntityCrossReference_3_8_1_0() { return cTestsTestableEntityCrossReference_3_8_1_0; }
		
		//QualifiedName
		public RuleCall getTestsTestableEntityQualifiedNameParserRuleCall_3_8_1_0_1() { return cTestsTestableEntityQualifiedNameParserRuleCall_3_8_1_0_1; }
		
		//'end'
		public Keyword getEndKeyword_3_8_2() { return cEndKeyword_3_8_2; }
		...
		//'requirements'
		public Keyword getRequirementsKeyword_3_9_0() { return cRequirementsKeyword_3_9_0; }
		
		//(demonstratesSatisfactionOf+=[TestRequirement|QualifiedName])*
		public Assignment getDemonstratesSatisfactionOfAssignment_3_9_1() { return cDemonstratesSatisfactionOfAssignment_3_9_1; }
		
		//[TestRequirement|QualifiedName]
		public CrossReference getDemonstratesSatisfactionOfTestRequirementCrossReference_3_9_1_0() { return cDemonstratesSatisfactionOfTestRequirementCrossReference_3_9_1_0; }
		
		//QualifiedName
		public RuleCall getDemonstratesSatisfactionOfTestRequirementQualifiedNameParserRuleCall_3_9_1_0_1() { return cDemonstratesSatisfactionOfTestRequirementQualifiedNameParserRuleCall_3_9_1_0_1; }
		
		//'end'
		public Keyword getEndKeyword_3_9_2() { return cEndKeyword_3_9_2; }
