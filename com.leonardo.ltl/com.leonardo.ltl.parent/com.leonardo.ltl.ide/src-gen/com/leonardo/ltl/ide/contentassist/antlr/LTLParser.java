...
public class LTLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LTLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTestSuiteAccess().getGroup_3_4(), "rule__TestSuite__Group_3_4__0");
			...
			builder.put(grammarAccess.getTestCaseAccess().getGroup_3_10(), "rule__TestCase__Group_3_10__0");
			builder.put(grammarAccess.getTestCaseAccess().getGroup_3_10_2(), "rule__TestCase__Group_3_10_2__0");
			builder.put(grammarAccess.getTestCaseAccess().getGroup_3_11(), "rule__TestCase__Group_3_11__0");
			...
			builder.put(grammarAccess.getTestSuiteAccess().getTestableEntitiesAssignment_3_4_1(), "rule__TestSuite__TestableEntitiesAssignment_3_4_1");
			...
			builder.put(grammarAccess.getTestCaseAccess().getActualResultAssignment_3_6_1(), "rule__TestCase__ActualResultAssignment_3_6_1");
			builder.put(grammarAccess.getTestCaseAccess().getPassedAssignment_3_7_1(), "rule__TestCase__PassedAssignment_3_7_1");
			builder.put(grammarAccess.getTestCaseAccess().getIncidentAssignment_3_8_1(), "rule__TestCase__IncidentAssignment_3_8_1");
			builder.put(grammarAccess.getTestCaseAccess().getPostconditionAssignment_3_9_1(), "rule__TestCase__PostconditionAssignment_3_9_1");
			builder.put(grammarAccess.getTestCaseAccess().getInputsAssignment_3_10_1(), "rule__TestCase__InputsAssignment_3_10_1");
			builder.put(grammarAccess.getTestCaseAccess().getInputsAssignment_3_10_2_1(), "rule__TestCase__InputsAssignment_3_10_2_1");
			builder.put(grammarAccess.getTestCaseAccess().getTestableEntitiesAssignment_3_11_1(), "rule__TestCase__TestableEntitiesAssignment_3_11_1");
